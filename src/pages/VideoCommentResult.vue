<template>
  ...
  <!-- 卡片样式 -->
  <div class="comment_info" style="position: absolute; left: 0px; top: 50px; right: 0px;padding-bottom: 80px;width: 400px;height: 400px">


    <!-- 骨架屏：包裹住要遮掩的内容   -->
    <van-skeleton title avatar :row="3" :loading="isSkeleton">

      <div id="comment" style="position: absolute; left: 0px; top: 50px; right: 0px;padding-bottom: 80px;width: 500px;height: 100px">
      <!--   卡片列表   -->
